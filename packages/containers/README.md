...
```
REGISTRY=ghcr.io/wearethelegion TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/wearethelegion TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/wearethelegion/build/bun-node:24.04
```
