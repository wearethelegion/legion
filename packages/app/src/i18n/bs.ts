export const dict = {
  ...
  "dialog.provider.legion.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Legion",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Legion-u.",
  ...
  "provider.connect.legionZen.line1":
    "Legion Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.legionZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.legionZen.visit.prefix": "Posjeti ",
  "provider.connect.legionZen.visit.link": "wearethelegion.com/zen",
  "provider.connect.legionZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Legion-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Legion-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u legion.json",
  ...
  "dialog.server.description": "Promijeni na koji se Legion server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Legion-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Legion timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (legion.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Legion još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Legion uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Legion server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Legion-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Legion izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Legion-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Legion pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Legion-a.",
