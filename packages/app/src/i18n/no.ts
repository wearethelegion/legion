...
export const dict = {
  ...
  "dialog.provider.legion.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Legion",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Legion.",
  ...
  "provider.connect.legionZen.line1":
    "Legion Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.legionZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.legionZen.visit.prefix": "Besøk ",
  "provider.connect.legionZen.visit.link": "wearethelegion.com/zen",
  "provider.connect.legionZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Legion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Legion.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i legion.json",
  ...
  "dialog.server.description": "Bytt hvilken Legion-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Legion ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Legion-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (legion.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Legion ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Legion inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Legion-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Legion",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Legion ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Legion er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Legion starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Legion.",
