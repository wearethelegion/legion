export const dict = {
  ...
  "dialog.provider.legion.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Legion",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Legion.",
  ...
  "provider.connect.legionZen.line1":
    "Legion Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.legionZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.legionZen.visit.prefix": "Visite ",
  "provider.connect.legionZen.visit.link": "wearethelegion.com/zen",
  "provider.connect.legionZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Legion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Legion.",
  ...
  "dialog.plugins.empty": "Plugins configurados em legion.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Legion este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Legion ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Legion",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (legion.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Legion ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Legion inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Legion dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Legion",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Legion aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Legion é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Legion iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Legion.",
