export const dict = {
  ...
  "dialog.provider.legion.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Legion",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Legion.",
  ...
  "provider.connect.legionZen.line1":
    "Legion Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.legionZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.legionZen.visit.prefix": "Odwiedź ",
  "provider.connect.legionZen.visit.link": "wearethelegion.com/zen",
  "provider.connect.legionZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Legion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Legion.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w legion.json",
  ...
  "dialog.server.description": "Przełącz serwer Legion, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Legion ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Legion",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (legion.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Legion does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Legion zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Legion server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Legion",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Legion na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Legion.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Legion",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Legion.",
