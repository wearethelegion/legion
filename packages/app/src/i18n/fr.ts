export const dict = {
  ...
  "dialog.provider.legion.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Legion",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Legion.",
  ...
  "provider.connect.legionZen.line1":
    "Legion Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.legionZen.visit.prefix": "Visitez ",
  "provider.connect.legionZen.visit.link": "wearethelegion.com/zen",
  "provider.connect.legionZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Legion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Legion.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans legion.json",
  ...
  "dialog.server.description": "Changez le serveur Legion auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Legion ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Legion",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (legion.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Legion ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Legion inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Legion dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Legion",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Legion sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Legion.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Legion",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Legion.",
