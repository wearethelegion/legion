...
beforeAll(async () => {
  ...
  mock.module("@wearethelegion/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@wearethelegion/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@wearethelegion/ui/icon", () => ({ Icon: () => null }))
  mock.module("@wearethelegion/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
