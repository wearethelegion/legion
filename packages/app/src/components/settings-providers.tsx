...
import { Tag } from "@wearethelegion/ui/tag"
import { showToast } from "@wearethelegion/ui/toast"
import { iconNames, type IconName } from "@wearethelegion/ui/icons/provider"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "legion", key: "dialog.provider.legion.note" },
...
export const SettingsProviders: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "legion" || Object.values(p.models).find((m) => m.cost?.input))
  })
