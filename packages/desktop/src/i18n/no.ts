export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Legion",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Legion er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'legion'-kommandoen.",
