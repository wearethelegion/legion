export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Legion",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Legion er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'legion'-kommandoen.",
