export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Legion",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Legion. ¿Quieres instalarla y reiniciar?",
