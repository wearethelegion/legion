---
title: TUI
description: Using the Legion terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Legion starts the TUI for the current directory.
...
When using the Legion TUI, you can type `/` followed by a command name to quickly execute actions. For example:
