---
title: Zen
description: legion ekibinin sundugu secili model listesi.
---
...
Legion Zen, legion ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
Legion Zen su anda beta asamasindadir.
:::

Zen, legion'daki diger provider'lar gibi calisir. Legion Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; legion kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
legion ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
Legion Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

Legion Zen, legion'daki diger provider'lar gibi calisir.

1. **<a href={console}>Legion Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, Legion Zen'i secin ve API anahtarinizi yapistirin
...
legion config'inizdeki [model id](/docs/config/#models), `legion/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `legion/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin legion'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin legion'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin legion'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin legion'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
Legion Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve legion'da diger provider'lari her zaman acik tutmak
