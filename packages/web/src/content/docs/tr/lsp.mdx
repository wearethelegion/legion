...
description: legion, LSP sunucularınızla bütünleşir.
---

legion, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

legion, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`LEGION_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP sunucularını, legion yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
