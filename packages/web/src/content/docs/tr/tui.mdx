---
title: TUI
description: legion terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

legion, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

legion'u calistirdiginizda mevcut dizin icin TUI baslar.
...
legion TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
legion'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
legion'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini legion config dosyanizdan ozellestirebilirsiniz.
