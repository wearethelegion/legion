---
title: 포매터
description: legion는 언어별 포매터를 사용합니다.
---

legion는 언어 별 형식을 사용하여 작성 또는 편집 한 후 자동으로 파일을 포맷합니다. 이 생성 된 코드는 프로젝트의 코드 스타일을 따릅니다.

---

## 내장

legion는 인기있는 언어 및 프레임 워크에 대한 몇 가지 내장 형식자와 함께 제공됩니다. 아래는 formatters, 지원된 파일 확장 및 명령 또는 구성 옵션의 목록입니다.
...
그래서 프로젝트가 `prettier`를 `package.json`에 가지고 있다면, legion는 자동으로 그것을 사용합니다.

---

## 작동 방식

legion가 파일을 작성하거나 편집할 때:
...
legion config의 `formatter` 섹션을 통해 형식기를 사용자 정의 할 수 있습니다.
