---
title: TUI
description: Bruke legion-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

legion gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre legion starter TUI for gjeldende katalog.
...
Når du bruker legion TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til legion. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt legion. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom legion-konfigurasjonsfilen.
