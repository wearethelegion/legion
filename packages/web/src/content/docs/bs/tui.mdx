---
title: TUI
description: Korištenje korisničkog interfejsa Legion terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Legion pokreće TUI za trenutni direktorij.
...
Kada koristite Legion TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Legion. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Legion. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg Legion konfiguracionog fajla.
