...
Kreiraj `.legion/commands/test.md`:
...
Možete dodati prilagođene komande kroz Legion konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Legion [config](/docs/config):
...
- Globalno: `~/.config/legion/commands/`
- Po projektu: `.legion/commands/`
...
Legion uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
