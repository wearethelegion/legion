...
Puede agregar comandos personalizados a través de la configuración Legion o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Legion [config](/docs/config):
...
legion incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
