---
title: Zen
description: Lista seleccionada de modelos proporcionada por Legion.
---
...
Legion Zen es una lista de modelos probados y verificados proporcionada por el equipo Legion.

:::note
Legion Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en Legion. Inicias sesion en Legion Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar Legion.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Legion.
:::
...
Legion Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

Legion Zen funciona como cualquier otro proveedor en Legion.

1. Inicias sesión en **<a href={console}>Legion Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona Legion Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de Legion
usa el formato `legion/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `legion/gpt-5.2-codex` en tu configuracion.
...
- GLM 4.7 Free está disponible en Legion por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en Legion por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en Legion por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en Legion por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con Legion también.
