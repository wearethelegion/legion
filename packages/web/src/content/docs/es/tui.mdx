---
title: TUI
description: Usando la interfaz de usuario del terminal Legion.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Legion se inicia TUI para el directorio actual.
...
Cuando utilice Legion TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Legion. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Legion. _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración Legion.
