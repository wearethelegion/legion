...
Utwórz `.legion/commands/test.md`:
...
Możesz zdefiniować polecenia w `legion.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji legion:
...
- Globalnie: `~/.config/legion/commands/`
- Na projekt: `.legion/commands/`
...
legion zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
