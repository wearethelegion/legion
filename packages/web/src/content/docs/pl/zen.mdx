---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez legion.
---
...
Legion Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół legion.

:::note
Legion Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca legion. Logujesz się do Legion Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z legion.
:::
...
Legion Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

Legion Zen działa jak każdy inny dostawca legion.

1. Logujesz się do **<a href={console}>Legion Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Legion Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji legion
używa formatu `legion/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `legion/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie legion przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na legion przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie legion przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w legion przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z legion dowolnego innego dostawcy.
