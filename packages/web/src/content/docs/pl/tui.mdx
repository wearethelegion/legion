---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala legion.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

legion zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie legion uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI legion, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do legion. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij legion. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego legion.
