---
title: TUI
description: Legion ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

Legion を実行すると、現在のディレクトリの TUI が開始されます。
...
Legion TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
Legion にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
Legion 設定ファイルを通じて TUI の動作をカスタマイズできます。
