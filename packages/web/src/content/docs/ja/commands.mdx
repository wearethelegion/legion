...
`.legion/commands/test.md` を作成します。
...
カスタムコマンドは、Legion 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Legion [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/legion/commands/`
- プロジェクトごと: `.legion/commands/`
...
Legion には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
