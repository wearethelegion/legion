---
title: Zen
description: Lista curata di modelli fornita da Legion.
---
...
Legion Zen e una lista di modelli testati e verificati dal team di Legion.

:::note
Legion Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Legion. Accedi a Legion Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Legion.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Legion.
:::
...
Legion Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

Legion Zen funziona come qualunque altro provider in Legion.

1. Accedi a **<a href={console}>Legion Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Legion Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Legion usa il formato `legion/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `legion/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su Legion per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su Legion per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su Legion per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Legion per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Legion.
