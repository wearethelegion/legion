...
Puoi aggiungere comandi personalizzati tramite la config di Legion o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Legion:
...
- Globale: `~/.config/legion/commands/`
- Per progetto: `.legion/commands/`
...
legion include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
