---
title: Zen
description: Lista selecionada de modelos fornecidos pelo legion.
---
...
O Legion Zen é uma lista de modelos testados e verificados fornecidos pela equipe do legion.

:::note
O Legion Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no legion. Você faz login no Legion Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o legion.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o legion.
:::
...
O Legion Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O Legion Zen funciona como qualquer outro provedor no legion.

1. Você faz login no **<a href={console}>Legion Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Legion Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do legion usa o formato `legion/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `legion/gpt-5.2-codex` na sua configuração.
...
- GLM 4.7 Free está disponível no legion por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Kimi K2.5 Free está disponível no legion por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- MiniMax M2.1 Free está disponível no legion por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no legion por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o legion também.
