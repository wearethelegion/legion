...
يوجد نوعان من الوكلاء في Legion: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Legion مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Legion مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Legion مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `legion.json`:
...
- عام: `~/.config/legion/agents/`
- لكل مشروع: `.legion/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Legion القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Legion العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Legion الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Legion Zen](/docs/zen)، فستستخدم `legion/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `legion models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/wearethelegion/legion).
:::
