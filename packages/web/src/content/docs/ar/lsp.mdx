---
title: خوادم LSP
description: يتكامل Legion مع خوادم LSP لديك.
---

يتكامل Legion مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Legion مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `LEGION_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات legion.
