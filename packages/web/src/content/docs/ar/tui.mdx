---
title: TUI
description: استخدام واجهة المستخدم TUI في Legion.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Legion واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Legion إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Legion في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Legion. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Legion. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Legion.
