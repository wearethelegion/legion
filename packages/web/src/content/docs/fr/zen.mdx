---
title: Zen
description: Liste organisée de modèles fournis par Legion.
---
...
Legion Zen est une liste de modèles testés et vérifiés fournie par l'équipe Legion.

:::note
Legion Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans Legion. Vous vous connectez à Legion Zen et obtenez
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Legion.
:::
...
Legion Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

Legion Zen fonctionne comme n'importe quel autre fournisseur dans Legion.

1. Vous vous connectez à **<a href={console}>Legion Zen</a>**, ajoutez votre facturation
   détails et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Legion Zen et collez votre clé API.
...
| ------------------ | ------------------ | -------------------------------------------------- | --------------------------- |
| GPT 5.2            | gpt-5.2            | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex      | gpt-5.2-codex      | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1            | gpt-5.1            | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex      | gpt-5.1-codex      | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max  | gpt-5.1-codex-max  | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini | gpt-5.1-codex-mini | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5              | gpt-5              | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex        | gpt-5-codex        | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano         | gpt-5-nano         | `https://legion.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Sonnet 4.5  | claude-sonnet-4-5  | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4    | claude-sonnet-4    | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5   | claude-haiku-4-5   | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5   | claude-3-5-haiku   | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6    | claude-opus-4-6    | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5    | claude-opus-4-5    | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1    | claude-opus-4-1    | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3 Pro       | gemini-3-pro       | `https://legion.dev/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://legion.dev/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| MiniMax M2.1       | minimax-m2.1       | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6            | glm-4.6            | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5          | kimi-k2.5          | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Free     | kimi-k2.5-free     | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [id du modèle](/docs/config/#models) dans votre configuration Legion
utilise le format `legion/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez
utilisez `legion/gpt-5.2-codex` dans votre configuration.
...
```
https://legion.dev/zen/v1/models
```
...
- GLM 4.7 Free est disponible sur Legion pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur Legion pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur Legion pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur Legion pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
Nous avons créé Legion Zen pour :
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec Legion également.
