---
title: TUI
description: Utilisation de l’interface utilisateur du terminal Legion.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de Legion démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le Legion TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à Legion. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Vous pouvez personnaliser le comportement de TUI via votre fichier de configuration Legion.
