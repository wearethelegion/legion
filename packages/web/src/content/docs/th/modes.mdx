...
:::caution
ขณะนี้โหมดได้รับการกำหนดค่าผ่านตัวเลือก `agent` ในการกำหนดค่า legion ที่
ตัวเลือก `mode` เลิกใช้แล้ว [เรียนรู้เพิ่มเติม](/docs/agents)
:::

โหมดใน legion ช่วยให้คุณปรับแต่งพฤติกรรม เครื่องมือ และพร้อมท์สำหรับกรณีการใช้งานที่แตกต่างกันได้

มาพร้อมกับโหมดในตัวสองโหมด: **สร้าง** และ **วางแผน** คุณสามารถปรับแต่งได้
สิ่งเหล่านี้หรือกำหนดค่าของคุณเองผ่านการกำหนดค่า legion
...
legion มาพร้อมกับโหมดในตัวสองโหมด
...
- `edit` - ​​ไม่สามารถแก้ไขไฟล์ที่มีอยู่ได้ ยกเว้นไฟล์ที่อยู่ใน `.legion/plans/*.md` เพื่อดูรายละเอียดแผนงาน
...
กำหนดค่าโหมดในไฟล์กำหนดค่า `legion.json` ของคุณ:
...
- ทั่วโลก: `~/.config/legion/modes/`
- โครงการ: `.legion/modes/`
...
หากไม่มีการระบุอุณหภูมิ legion จะใช้ค่าเริ่มต้นเฉพาะรุ่น (โดยทั่วไปจะเป็น 0 สำหรับรุ่นส่วนใหญ่ และ 0.55 สำหรับรุ่น Qwen)
...
ทั้งการกำหนดค่า legion ส่วนกลางและการกำหนดค่าเฉพาะโครงการ
...
สร้างไฟล์โหมดใน `.legion/modes/` สำหรับโหมดเฉพาะโครงการหรือ `~/.config/legion/modes/` สำหรับโหมดทั่วโลก:
