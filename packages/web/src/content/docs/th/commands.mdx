...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Legion:
...
- ระดับผู้ใช้ (Global): `~/.config/legion/commands/`
- ระดับโปรเจ็กต์: `.legion/commands/`
...
Legion มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
