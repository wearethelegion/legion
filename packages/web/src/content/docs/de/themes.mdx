...
Mit Legion kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Legion das `legion`-Theme.
...
Legion liefert mehrere eingebaute Themes mit.
...
- Legion optisch ans Terminal anpassen wollen
...
Legion unterstuetzt ein flexibles JSON-basiertes Theme-System.
