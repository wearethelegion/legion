---
title: TUI
description: Arbeite mit Legion in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Legion die TUI im aktuellen Verzeichnis.
...
In der Legion-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to Legion. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Legion config file.
