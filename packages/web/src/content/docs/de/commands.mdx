...
Erstellen Sie `.legion/commands/test.md`:

```md title=".legion/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Legion-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Legion [config](/docs/config):

```json title="legion.jsonc" {4-12}
{
...
- Global: `~/.config/legion/commands/`
- Pro Projekt: `.legion/commands/`

```markdown title="~/.config/legion/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".legion/commands/component.md"
---
...
```md title=".legion/commands/create-file.md"
---
...
```md title=".legion/commands/analyze-coverage.md"
---
...
```md title=".legion/commands/review-changes.md"
---
...
```md title=".legion/commands/review-component.md"
---
...
Legion enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
