---
title: LSP-servere
description: Legion integreres med dine LSP-servere.
---

Legion integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Legion leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `LEGION_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når legion åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din legion-konfiguration.
