---
title: TUI
description: Brug af Legion-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Legion giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Legion starter TUI for den nuværende mappe.
...
Når du bruger Legion TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Legion. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Legion. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-adfærden gennem Legion-konfigurationsfilen.
