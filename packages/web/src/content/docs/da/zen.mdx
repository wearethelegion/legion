---
title: Zen
description: Udvalgt liste over modeller leveret af Legion.
---
...
Legion Zen er en liste over testede og verificerede modeller leveret af Legion-teamet.

:::note
Legion Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Legion. Du logger på Legion Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Legion.
:::
...
Legion Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Legion Zen fungerer som alle andre udbydere i Legion.

1. Du logger på **<a href={console}>Legion Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Legion Zen og indsætter API-nøglen.
...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://legion.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://legion.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i Legion-konfigurationen
bruger formatet `legion/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `legion/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på Legion i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på Legion i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på Legion i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Legion i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede Legion Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Legion også.
