...
import compareVideo from "../../asset/lander/legion-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/legion-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="legion:auth" content={loggedin() ? "true" : "false"} />
