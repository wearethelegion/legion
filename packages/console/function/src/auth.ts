...
import { Account } from "@wearethelegion/console-core/account.js"
import { Workspace } from "@wearethelegion/console-core/workspace.js"
import { Actor } from "@wearethelegion/console-core/actor.js"
import { Resource } from "@wearethelegion/console-resource"
import { User } from "@wearethelegion/console-core/user.js"
import { and, Database, eq, isNull, or } from "@wearethelegion/console-core/drizzle/index.js"
...
import { AuthTable } from "@wearethelegion/console-core/schema/auth.sql.js"
...
const MY_THEME: Theme = {
  ...THEME_OPENAUTH,
  logo: "https://wearethelegion.com/favicon-v3.svg",
}
  ...
  async fetch(request: Request, env: Env, ctx: ExecutionContext) {
    const result = await issuer({
      ...
      async success(ctx, response) {
        ...
        if (Resource.App.stage !== "production" && !email.endsWith("@wearethelegion.com")) {
