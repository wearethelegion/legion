...
function App() {
  ...
  useKeyboard((evt) => {
    if (!Flag.LEGION_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) return
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.LEGION_DISABLE_TERMINAL_TITLE) return
    ...
    if (route.data.type === "session") {
      ...
      renderer.setTerminalTitle(`LEGION | ${title}`)
    }
  })
  ...
  command.register(() => [
    ...
    },
    {
      ...
      value: "docs.open",
      onSelect: () => {
        open("https://wearethelegion.com/docs").catch(() => {})
        dialog.clear()
      },
      category: "System",
    },
    ...
    if (currentModel.providerID === "openrouter" && !kv.get("openrouter_warning", false)) {
      untrack(() => {
        DialogAlert.show(
          dialog,
          "Warning",
          "While openrouter is a convenient way to access LLMs your request will often be routed to subpar providers that do not work well in our testing.\n\nFor reliable access to models check out Legion Zen\nhttps://wearethelegion.com/zen",
  ...
  sdk.event.on(Installation.Event.UpdateAvailable.type, (evt) => {
    toast.show({
      ...
      message: `LEGION v${evt.properties.version} is available. Run 'legion upgrade' to update manually.`,
      duration: 10000,
    })
  })
  ...
  return (
    <box
      ...
      onMouseUp={Flag.LEGION_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? undefined : () => Selection.copy(renderer, toast)}
    >
      <Switch>
...
function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/wearethelegion/legion/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("legion-version", Installation.VERSION)
