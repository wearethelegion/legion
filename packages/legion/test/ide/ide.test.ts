...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LEGION_CALLER", () => {
    process.env["LEGION_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LEGION_CALLER", () => {
    process.env["LEGION_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LEGION_CALLER", () => {
    process.env["LEGION_CALLER"] = "unknown"
