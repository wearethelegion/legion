...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/legion.git")).toEqual({ owner: "sst", repo: "legion" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/legion")).toEqual({ owner: "sst", repo: "legion" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/legion.git")).toEqual({ owner: "sst", repo: "legion" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/legion")).toEqual({ owner: "sst", repo: "legion" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/legion.git")).toEqual({ owner: "sst", repo: "legion" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/legion")).toEqual({ owner: "sst", repo: "legion" })
})
