...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/wearethelegion/legion/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for wearethelegion/legion...\n")
...
console.log("Fetching npm all-time downloads for legion...\n")
const npmDownloads = await fetchNpmDownloads("legion")
